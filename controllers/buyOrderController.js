...
const createOrder = async (req, res) => {
  ...
  res.header("Access-Control-Allow-Origin", "https://orders-frontend.netlify.app"); // replace 'https://orders-frontend.netlify.app' with your frontend's URL in production
  res.header(
